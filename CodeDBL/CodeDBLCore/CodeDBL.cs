...
namespace CodeDBLCore
{
    public sealed class CodeDBL : ICodeDBL
    {
        ...
        /// </summary>
        public CodeDBL(DBMS connectionTo, String connectionString) : this()
        {
        ...
        /// <returns></returns>
        public InsertStatement InsertInto<Table>(Table table) where Table : Shared.Table
        ...
        /// <returns></returns>
        public DeleteStatement DeleteFrom<Table>(Func<Table, Boolean> where) where Table : Shared.Table
        ...
        /// <param name="where"></param>
        /// <returns></returns>
        public UpdateStatement Update<Table>(Func<Table, Boolean> where) where Table : Shared.Table
